...
#include "common/json_payload.hpp"
...
grpc::Status NatsPublisherServiceImpl::PublishMeterReading(
    grpc::ServerContext* /*context*/,
    const nats::v1::PublishMeterReadingRequest* request,
    nats::v1::PublishMeterReadingResponse* response) {
  ...
  const std::string payload = reading_to_json(request->reading());
  ...
  spdlog::info("published to {} seq={} asset={} power={:.2f} kW", subject, seq,
